      ...
      <Wrapper>
        <div className="flex flex-col lg:flex-row md:px-10 gap-[50px] lg:gap-[100px]">
          ...
          <div className="flex-[1] py-3">
            {/* product title */}
            <div className="text-[34px] text-slate-900 font-semibold mb-2">{p.name}</div>

            {/* Product subtitle */}
            <div className="text-lg text-slate-900 font-semibold mb-5">{p.subtitle}</div>

            {/* Product Price */}
            <div className="flex items-center">
              <p className="mr-2 text-lg text-slate-900 font-semibold">MRP : ${p.price}</p>
              {p.original_price && (
                <>
                  <p className="text-base text-slate-900 font-medium line-through">
                    ${p.original_price}
                  </p>
